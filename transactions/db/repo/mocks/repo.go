...
// Source: ./transactions/db/repo (interfaces: TransactionsRepo,MerchantRepo,CustomerRepo,DepositRepo,PayoutRepo,DisputeRepo)
//
// Generated by this command:
//
//	mockgen -destination transactions/db/repo/mocks/repo.go -package mocks ./transactions/db/repo TransactionsRepo,MerchantRepo,CustomerRepo,DepositRepo,PayoutRepo,DisputeRepo
//
...
// CountFiltered mocks base method.
func (m *MockDisputeRepo) CountFiltered(ctx context.Context, search, status string) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountFiltered", ctx, search, status)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
...
// CountFiltered indicates an expected call of CountFiltered.
func (mr *MockDisputeRepoMockRecorder) CountFiltered(ctx, search, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountFiltered", reflect.TypeOf((*MockDisputeRepo)(nil).CountFiltered), ctx, search, status)
}

// GetByID mocks base method.
func (m *MockDisputeRepo) GetByID(ctx context.Context, id uuid.UUID) (sqlc.GetDisputeByIDRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByID", ctx, id)
...
// GetByID indicates an expected call of GetByID.
func (mr *MockDisputeRepoMockRecorder) GetByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByID", reflect.TypeOf((*MockDisputeRepo)(nil).GetByID), ctx, id)
}

// GetStats mocks base method.
func (m *MockDisputeRepo) GetStats(ctx context.Context) (sqlc.GetDisputeStatsRow, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDisputeRepoMockRecorder) GetStats(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStats", reflect.TypeOf((*MockDisputeRepo)(nil).GetStats), ctx)
}

// ListFiltered mocks base method.
func (m *MockDisputeRepo) ListFiltered(ctx context.Context, search, status string, limit, offset int32) ([]sqlc.ListDisputesFilteredRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListFiltered", ctx, search, status, limit, offset)
...
// ListFiltered indicates an expected call of ListFiltered.
func (mr *MockDisputeRepoMockRecorder) ListFiltered(ctx, search, status, limit, offset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListFiltered", reflect.TypeOf((*MockDisputeRepo)(nil).ListFiltered), ctx, search, status, limit, offset)
}

// SubmitEvidence mocks base method.
func (m *MockDisputeRepo) SubmitEvidence(ctx context.Context, id uuid.UUID) (sqlc.Dispute, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDisputeRepoMockRecorder) SubmitEvidence(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubmitEvidence", reflect.TypeOf((*MockDisputeRepo)(nil).SubmitEvidence), ctx, id)
}

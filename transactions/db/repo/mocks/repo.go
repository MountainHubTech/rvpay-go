...
// Source: ./transactions/db/repo (interfaces: TransactionsRepo,MerchantRepo,CustomerRepo,DepositRepo,PayoutRepo)
//
// Generated by this command:
//
//	mockgen -destination transactions/db/repo/mocks/repo.go -package mocks ./transactions/db/repo TransactionsRepo,MerchantRepo,CustomerRepo,DepositRepo,PayoutRepo
//

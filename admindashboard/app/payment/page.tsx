...
{provider.name.split(" ").map((word, i) => ( <span key={i} className="block">
{word} </span>
))} </span> </div>
);
}
...
return ( <div className="flex min-h-screen flex-col items-center bg-[#eceff2] px-4 py-16"> <h1 className="mb-6 text-base font-semibold text-foreground">
Make payment </h1>
        ...
        <div className="mt-1 flex items-center justify-between">
          {editingAmount ? (
            <input
              ...
              onKeyDown={(e) =>
                e.key === "Enter" && setEditingAmount(false)
              }
